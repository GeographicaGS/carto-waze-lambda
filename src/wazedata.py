        ...
        if alerts_raw:
            ...
            for alert in alerts_raw:
                ...
                alerts.append({
                    ...
                    'street': self.__format_text(alert.get('street')),
        ...
        if jams_raw:
            ...
            for jam in jams_raw:
                ...
                jams.append({
                    ...
                    'city': self.__format_text(jam.get('city')),
                    'speed': jam.get('speed'),
                    'length': jam.get('length'),
                    'level': jam.get('level'),
                    'delay': jam.get('delay'),
                    'startnode': self.__format_text(jam.get('startNode')),
                    'endnode': self.__format_text(jam.get('endNode')),
                    'street': self.__format_text(jam.get('street')),
        ...
        if irrgs_raw:
            ...
            for irrg in irrgs_raw:
                ...
                irrgs.append({
                    ...
                    'city': self.__format_text(irrg.get('city')),
                    ...
                    'startnode': self.__format_text(irrg.get('startNode')),
                    'endnode':  self.__format_text(irrg.get('endNode')),
                    'street':  self.__format_text(irrg.get('street')),
                    'type': irrg.get('type'),
                    'id': irrg.get('id'),
